...
{
    public class GameSettingsForm_old : Form
    {
        ...
        private void initializeComponents()
        {
            ...
            m_RadioButtonOpOne.Click += radioButtonOpOne_Checked;
            ...
            m_TextBoxPlayerOne.TextChanged += textBoxPlayerOne_TextChanged;
            ...
            m_TextBoxPlayerTwo.TextChanged += textBoxPlayerTwo_TextChanged;
        ...
        private void radioButtonOpOne_Checked(Object sender,EventArgs e)
        {
            m_BoardSize = BusinessLogic.GlobalDefines.Rs_AllowedBoardSizes[0];
        }

        private void radioButtonOpTwo_Checked(Object sender, EventArgs e)
        {
            m_BoardSize = BusinessLogic.GlobalDefines.Rs_AllowedBoardSizes[1];
        }

        private void radioButtonOpThree_Checked(Object sender, EventArgs e)
        {
            m_BoardSize = BusinessLogic.GlobalDefines.Rs_AllowedBoardSizes[2];
        }
